...
import { SqlExecutor } from '../src/adapters/persistence/sql-executor.js';
...
export async function runMigrations(executor: SqlExecutor, config: MigrationConfig = {}) {
  ...
  console.log(`📦 Applying Schema: ${schemaFile} (Partitioning: ${partitionTables})`);
